...
class ETFA2019TransmissionPoint(TransmissionPoint):

    __slots__ = ("_is_to_host", )

    def __init__(self, switch_connector, partial_streams, transmission_times, is_to_host):
        super(ETFA2019TransmissionPoint, self).__init__(switch_connector, partial_streams, transmission_times)
...
class ETFA2019PathBasedSchedule(Schedule):

    __slots__ = ("_pathset",)

    def __init__(self, scheduler):
        super(ETFA2019PathBasedSchedule, self).__init__(scheduler)
        self._pathset = ETFA2019PathSet()
...
class ETFA2019Scheduler(Scheduler):
    """
    transmission times are given as [start; end)
    """

    TOPOLOGY_CLS = ETFA2019Topology
    SCHEDULE_CLS = ETFA2019PathBasedSchedule
    ...
    def __init__(self, odl_client, flow_priority):
        super(ETFA2019Scheduler, self).__init__(odl_client)
